...
```
>While the table already shows differences in mean ratings for the two directors, we construct a boxplot to make more sense of our data in the following. 
